...
# Country Codes (ISO 3166-1) with Calling Codes
COUNTRY_CODES = [
    # Caribbean (CARICOM)
    {"code": "BS", "alpha3": "BHS", "name": "Bahamas", "calling_code": "+1-242", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "Domestic - no import duty"},
    {"code": "BB", "alpha3": "BRB", "name": "Barbados", "calling_code": "+1-246", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "JM", "alpha3": "JAM", "name": "Jamaica", "calling_code": "+1-876", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "TT", "alpha3": "TTO", "name": "Trinidad and Tobago", "calling_code": "+1-868", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "GY", "alpha3": "GUY", "name": "Guyana", "calling_code": "+592", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "SR", "alpha3": "SUR", "name": "Suriname", "calling_code": "+597", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "BZ", "alpha3": "BLZ", "name": "Belize", "calling_code": "+501", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "HT", "alpha3": "HTI", "name": "Haiti", "calling_code": "+509", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "AG", "alpha3": "ATG", "name": "Antigua and Barbuda", "calling_code": "+1-268", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "DM", "alpha3": "DMA", "name": "Dominica", "calling_code": "+1-767", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "GD", "alpha3": "GRD", "name": "Grenada", "calling_code": "+1-473", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "KN", "alpha3": "KNA", "name": "Saint Kitts and Nevis", "calling_code": "+1-869", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "LC", "alpha3": "LCA", "name": "Saint Lucia", "calling_code": "+1-758", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "VC", "alpha3": "VCT", "name": "Saint Vincent and the Grenadines", "calling_code": "+1-784", "region": "Caribbean", "trade_agreement": "CARICOM", "notes": "CARICOM preferential rates apply"},
    {"code": "CU", "alpha3": "CUB", "name": "Cuba", "calling_code": "+53", "region": "Caribbean", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "DO", "alpha3": "DOM", "name": "Dominican Republic", "calling_code": "+1-809", "region": "Caribbean", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "PR", "alpha3": "PRI", "name": "Puerto Rico", "calling_code": "+1-787", "region": "Caribbean", "trade_agreement": None, "notes": "US Territory - standard rates"},
    {"code": "VI", "alpha3": "VIR", "name": "US Virgin Islands", "calling_code": "+1-340", "region": "Caribbean", "trade_agreement": None, "notes": "US Territory - standard rates"},
    {"code": "TC", "alpha3": "TCA", "name": "Turks and Caicos Islands", "calling_code": "+1-649", "region": "Caribbean", "trade_agreement": None, "notes": "UK Territory - standard rates"},
    {"code": "KY", "alpha3": "CYM", "name": "Cayman Islands", "calling_code": "+1-345", "region": "Caribbean", "trade_agreement": None, "notes": "UK Territory - standard rates"},
    {"code": "AW", "alpha3": "ABW", "name": "Aruba", "calling_code": "+297", "region": "Caribbean", "trade_agreement": None, "notes": "Netherlands Territory"},
    {"code": "CW", "alpha3": "CUW", "name": "Curaçao", "calling_code": "+599", "region": "Caribbean", "trade_agreement": None, "notes": "Netherlands Territory"},
    {"code": "BM", "alpha3": "BMU", "name": "Bermuda", "calling_code": "+1-441", "region": "Caribbean", "trade_agreement": None, "notes": "UK Territory"},
    
    # North America
    {"code": "US", "alpha3": "USA", "name": "United States", "calling_code": "+1", "region": "North America", "trade_agreement": None, "notes": "Major trading partner - standard rates"},
    {"code": "CA", "alpha3": "CAN", "name": "Canada", "calling_code": "+1", "region": "North America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "MX", "alpha3": "MEX", "name": "Mexico", "calling_code": "+52", "region": "North America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    
    # Central America
    {"code": "PA", "alpha3": "PAN", "name": "Panama", "calling_code": "+507", "region": "Central America", "trade_agreement": None, "notes": "Free trade zone country"},
    {"code": "CR", "alpha3": "CRI", "name": "Costa Rica", "calling_code": "+506", "region": "Central America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "GT", "alpha3": "GTM", "name": "Guatemala", "calling_code": "+502", "region": "Central America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "HN", "alpha3": "HND", "name": "Honduras", "calling_code": "+504", "region": "Central America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "NI", "alpha3": "NIC", "name": "Nicaragua", "calling_code": "+505", "region": "Central America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "SV", "alpha3": "SLV", "name": "El Salvador", "calling_code": "+503", "region": "Central America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    
    # South America
    {"code": "BR", "alpha3": "BRA", "name": "Brazil", "calling_code": "+55", "region": "South America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "AR", "alpha3": "ARG", "name": "Argentina", "calling_code": "+54", "region": "South America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "CO", "alpha3": "COL", "name": "Colombia", "calling_code": "+57", "region": "South America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "CL", "alpha3": "CHL", "name": "Chile", "calling_code": "+56", "region": "South America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "PE", "alpha3": "PER", "name": "Peru", "calling_code": "+51", "region": "South America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "EC", "alpha3": "ECU", "name": "Ecuador", "calling_code": "+593", "region": "South America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "VE", "alpha3": "VEN", "name": "Venezuela", "calling_code": "+58", "region": "South America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "UY", "alpha3": "URY", "name": "Uruguay", "calling_code": "+598", "region": "South America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "PY", "alpha3": "PRY", "name": "Paraguay", "calling_code": "+595", "region": "South America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "BO", "alpha3": "BOL", "name": "Bolivia", "calling_code": "+591", "region": "South America", "trade_agreement": None, "notes": "Standard duty rates apply"},
    
    # Europe
    {"code": "GB", "alpha3": "GBR", "name": "United Kingdom", "calling_code": "+44", "region": "Europe", "trade_agreement": None, "notes": "Commonwealth member - standard rates"},
    {"code": "DE", "alpha3": "DEU", "name": "Germany", "calling_code": "+49", "region": "Europe", "trade_agreement": None, "notes": "Major EU trading partner"},
    {"code": "FR", "alpha3": "FRA", "name": "France", "calling_code": "+33", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "IT", "alpha3": "ITA", "name": "Italy", "calling_code": "+39", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "ES", "alpha3": "ESP", "name": "Spain", "calling_code": "+34", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "NL", "alpha3": "NLD", "name": "Netherlands", "calling_code": "+31", "region": "Europe", "trade_agreement": None, "notes": "Major port - transit goods"},
    {"code": "BE", "alpha3": "BEL", "name": "Belgium", "calling_code": "+32", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "CH", "alpha3": "CHE", "name": "Switzerland", "calling_code": "+41", "region": "Europe", "trade_agreement": None, "notes": "Luxury goods source"},
    {"code": "IE", "alpha3": "IRL", "name": "Ireland", "calling_code": "+353", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "PT", "alpha3": "PRT", "name": "Portugal", "calling_code": "+351", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "SE", "alpha3": "SWE", "name": "Sweden", "calling_code": "+46", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "NO", "alpha3": "NOR", "name": "Norway", "calling_code": "+47", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "DK", "alpha3": "DNK", "name": "Denmark", "calling_code": "+45", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "PL", "alpha3": "POL", "name": "Poland", "calling_code": "+48", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "AT", "alpha3": "AUT", "name": "Austria", "calling_code": "+43", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "GR", "alpha3": "GRC", "name": "Greece", "calling_code": "+30", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "FI", "alpha3": "FIN", "name": "Finland", "calling_code": "+358", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "CZ", "alpha3": "CZE", "name": "Czech Republic", "calling_code": "+420", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "RO", "alpha3": "ROU", "name": "Romania", "calling_code": "+40", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "HU", "alpha3": "HUN", "name": "Hungary", "calling_code": "+36", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "RU", "alpha3": "RUS", "name": "Russia", "calling_code": "+7", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "UA", "alpha3": "UKR", "name": "Ukraine", "calling_code": "+380", "region": "Europe", "trade_agreement": None, "notes": "Standard duty rates apply"},
    
    # Asia
    {"code": "CN", "alpha3": "CHN", "name": "China", "calling_code": "+86", "region": "Asia", "trade_agreement": None, "notes": "Major import source - standard rates"},
    {"code": "JP", "alpha3": "JPN", "name": "Japan", "calling_code": "+81", "region": "Asia", "trade_agreement": None, "notes": "Electronics and vehicles source"},
    {"code": "KR", "alpha3": "KOR", "name": "South Korea", "calling_code": "+82", "region": "Asia", "trade_agreement": None, "notes": "Electronics and vehicles source"},
    {"code": "TW", "alpha3": "TWN", "name": "Taiwan", "calling_code": "+886", "region": "Asia", "trade_agreement": None, "notes": "Electronics manufacturing"},
    {"code": "HK", "alpha3": "HKG", "name": "Hong Kong", "calling_code": "+852", "region": "Asia", "trade_agreement": None, "notes": "Major transit hub"},
    {"code": "SG", "alpha3": "SGP", "name": "Singapore", "calling_code": "+65", "region": "Asia", "trade_agreement": None, "notes": "Major transit hub"},
    {"code": "TH", "alpha3": "THA", "name": "Thailand", "calling_code": "+66", "region": "Asia", "trade_agreement": None, "notes": "Manufacturing source"},
    {"code": "VN", "alpha3": "VNM", "name": "Vietnam", "calling_code": "+84", "region": "Asia", "trade_agreement": None, "notes": "Textiles and manufacturing"},
    {"code": "MY", "alpha3": "MYS", "name": "Malaysia", "calling_code": "+60", "region": "Asia", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "ID", "alpha3": "IDN", "name": "Indonesia", "calling_code": "+62", "region": "Asia", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "PH", "alpha3": "PHL", "name": "Philippines", "calling_code": "+63", "region": "Asia", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "IN", "alpha3": "IND", "name": "India", "calling_code": "+91", "region": "Asia", "trade_agreement": None, "notes": "Commonwealth member"},
    {"code": "BD", "alpha3": "BGD", "name": "Bangladesh", "calling_code": "+880", "region": "Asia", "trade_agreement": None, "notes": "Textiles source"},
    {"code": "PK", "alpha3": "PAK", "name": "Pakistan", "calling_code": "+92", "region": "Asia", "trade_agreement": None, "notes": "Textiles source"},
    {"code": "LK", "alpha3": "LKA", "name": "Sri Lanka", "calling_code": "+94", "region": "Asia", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "NP", "alpha3": "NPL", "name": "Nepal", "calling_code": "+977", "region": "Asia", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "MM", "alpha3": "MMR", "name": "Myanmar", "calling_code": "+95", "region": "Asia", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "KH", "alpha3": "KHM", "name": "Cambodia", "calling_code": "+855", "region": "Asia", "trade_agreement": None, "notes": "Textiles manufacturing"},
    
    # Middle East
    {"code": "AE", "alpha3": "ARE", "name": "United Arab Emirates", "calling_code": "+971", "region": "Middle East", "trade_agreement": None, "notes": "Dubai - major transit hub"},
    {"code": "SA", "alpha3": "SAU", "name": "Saudi Arabia", "calling_code": "+966", "region": "Middle East", "trade_agreement": None, "notes": "Petroleum source"},
    {"code": "IL", "alpha3": "ISR", "name": "Israel", "calling_code": "+972", "region": "Middle East", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "TR", "alpha3": "TUR", "name": "Turkey", "calling_code": "+90", "region": "Middle East", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "QA", "alpha3": "QAT", "name": "Qatar", "calling_code": "+974", "region": "Middle East", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "KW", "alpha3": "KWT", "name": "Kuwait", "calling_code": "+965", "region": "Middle East", "trade_agreement": None, "notes": "Petroleum source"},
    {"code": "BH", "alpha3": "BHR", "name": "Bahrain", "calling_code": "+973", "region": "Middle East", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "OM", "alpha3": "OMN", "name": "Oman", "calling_code": "+968", "region": "Middle East", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "JO", "alpha3": "JOR", "name": "Jordan", "calling_code": "+962", "region": "Middle East", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "LB", "alpha3": "LBN", "name": "Lebanon", "calling_code": "+961", "region": "Middle East", "trade_agreement": None, "notes": "Standard duty rates apply"},
    
    # Africa
    {"code": "ZA", "alpha3": "ZAF", "name": "South Africa", "calling_code": "+27", "region": "Africa", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "NG", "alpha3": "NGA", "name": "Nigeria", "calling_code": "+234", "region": "Africa", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "EG", "alpha3": "EGY", "name": "Egypt", "calling_code": "+20", "region": "Africa", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "KE", "alpha3": "KEN", "name": "Kenya", "calling_code": "+254", "region": "Africa", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "GH", "alpha3": "GHA", "name": "Ghana", "calling_code": "+233", "region": "Africa", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "MA", "alpha3": "MAR", "name": "Morocco", "calling_code": "+212", "region": "Africa", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "ET", "alpha3": "ETH", "name": "Ethiopia", "calling_code": "+251", "region": "Africa", "trade_agreement": None, "notes": "Standard duty rates apply"},
    {"code": "TZ", "alpha3": "TZA", "name": "Tanzania", "calling_code": "+255", "region": "Africa", "trade_agreement": None, "notes": "Standard duty rates apply"},
    
    # Oceania
    {"code": "AU", "alpha3": "AUS", "name": "Australia", "calling_code": "+61", "region": "Oceania", "trade_agreement": None, "notes": "Commonwealth member"},
    {"code": "NZ", "alpha3": "NZL", "name": "New Zealand", "calling_code": "+64", "region": "Oceania", "trade_agreement": None, "notes": "Commonwealth member"},
